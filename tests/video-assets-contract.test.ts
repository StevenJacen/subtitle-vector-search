...
describe('visual plan', () => {
  ...
  it.each([
    ...
    're-enacting this famous scene at sunrise',
    're-created famous movie scene at sunrise',
    'non-binary person opening curtains at sunrise',
    'non-binaries walking through a city',
    'lesbians opening curtains at sunrise',
    'women opening curtains at sunrise',
    'veterans returning home at sunrise',
    'Taylor opening curtains at sunrise',
    'TAYLOR opening curtains at sunrise',
    'Taylor-Swift opening curtains at sunrise',
    'gandalf walking through a forest',
    'family visiting disneyland at sunset',
  ...
  it.each([
    ...
    'Dog Running On Beach Video',
    'Ocean Waves At Sunset Video',
