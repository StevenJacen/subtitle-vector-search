...
export function buildPlannerPrompt(input: VisualPlannerInput): string {
  return [
    ...
    'Each query object must contain exactly kind and term, for example: {"kind":"literal","term":"..."}.',
    ...
    'Do not use character names, trademarks, copyrighted references, or language that recreates a protected scene.',
    'Do not invent protected traits such as age, gender, race, ethnicity, disability, religion, or other personal traits.',
